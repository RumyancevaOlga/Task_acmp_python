...
# цифре полученного в результате вычитания числа само это число. Например, если Вася загадал число 487, то 
# перестановкой первой и последней цифры он получит число 784. После чего ему придется вычесть из 784 число 487, 
...
with open('INPUT.txt', 'r') as my_f:
    first_number = int(my_f.readline())

second_number = 90
third_number = 9 - first_number

numbers = first_number * 100 + second_number + third_number

with open('OUTPUT.txt', 'w') as my_f1:
    my_f1.write(str(numbers))