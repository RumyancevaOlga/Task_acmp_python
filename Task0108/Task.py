...
# Обозначим за Fi(x) функцию, которая преобразует текст передаваемой информации x в ту, 
# которую получит участник i+1 от участника i. Тогда последний n-й участник получит данные y, 
...
with open('INPUT.txt', 'r') as my_f:
    telephone = my_f.readline()

with open('OUTPUT.txt', 'w') as my_f1:
    my_f1.write(telephone)