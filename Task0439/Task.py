# Параллельное программирование изучает методы построения программ, которые будут выполняться на нескольких процессорах.
# В результате решения одной из первых задач этого раздела информатики появился закон Амдала.
#
# Задача Амдала формулировалась так. Имеется n процессоров и p процентов вычислений не могут выполняться параллельно.
# Во сколько раз быстрее можно выполнить вычисления по сравнению с одним процессором?
#
...
# выполнены за время 3•t/(4•10) , а оставшиеся 25% - за время t/4 . Общее время вычислений в этом случае составит
# t/4 + 3•t/40 = 13•t/40, а ускорение по сравнению с одним процессором составит 40/13 раза.
#
